...
class Reranker:
    def __init__(self, model_id, batch_size=8, max_length=768):
        self.tokenizer = AutoTokenizer.from_pretrained(model_id)
        self.device = os.getenv("STOP_RAG_RERANKER_DEVICE")
        if self.device:
...
def test():
    ...
    batch_docs = [
        [
            {
                "id": "2hop__29893_29898-07//2hop__252311_366220-14//2hop__29893_29905-19",
                "title": "WCCO-TV",
            ...
            {
                "id": "2hop__252311_366220-15",
                "title": "Marketwired",
                "text": "Marketwired: Marketwired is a press release distribution service headquartered in Toronto, Ontario, Canada. Marketwired was founded in 1993 and incorporated in the U.S. in 1999. The company distributes press releases via traditional methods (Associated Press, Bloomberg, etc.) as well as new media methods and other services.",
            },
            {
                "id": "2hop__477492_240386-15//2hop__252311_366220-16",
                "title": "Equity Music Group",
                "text": "Equity Music Group: Equity Music Group was an American country music record label founded in 2003 by singer Clint Black. The label was distributed by Koch Entertainment (now E1 Entertainment).",
            },
            {
                "id": "2hop__252311_366220-17",
                "title": "List of tallest structures",
                "text": "The Baldevins bryllup director died in the tallest structure in the world, KVLY - TV mast 628.8 m (2,063 ft) 1963 Guyed mast VHF - UHF transmission United States Blanchard, North Dakota.",
            },
        ],
        [
            {
            ...
            },
            {
                "id": "2hop__252311_366220-17",
                "title": "List of tallest structures",
                "text": "List of tallest structures: KVLY - TV mast 628.8 m (2,063 ft) 1963 Guyed mast VHF - UHF transmission United States Blanchard, North Dakota Tallest mast in the world 47 \u00b0 20 \u2032 31.85 ''N 97 \u00b0 17 \u2032 21.13'' W \ufeff / \ufeff 47.3421806 \u00b0 N 97.2892028 \u00b0 W \ufeff / 47.3421806; - 97.2892028 \ufeff (KVLY - TV mast)",
            },
        ],
    ]
