...
- 结果总览：[stage3_results_summary.md](stage3_results_summary.md)
- 论文叙事：[stage3_narrative.md](stage3_narrative.md)
- 本页收尾：[stage3_closeout.md](stage3_closeout.md)

本轮新增并补齐的 Pareto 图：

- 总览图：[results/stage3_final_pareto_all.png](../../../results/stage3_final_pareto_all.png)
- 分数据集图：
  [results/stage3_final_pareto_hotpotqa.png](../../../results/stage3_final_pareto_hotpotqa.png)
  [results/stage3_final_pareto_musique.png](../../../results/stage3_final_pareto_musique.png)
  [results/stage3_final_pareto_2wiki.png](../../../results/stage3_final_pareto_2wiki.png)
