...
> 收尾状态：**Stage 3 已正式关闭**；最终归档见 `docs/reports/stage3/stage3_closeout.md`，统一 Pareto 图见 `results/stage3_final_pareto_all.png`。
...
- 配套报告：`docs/reports/stage3/stage3_report_*.md`
- 叙事整理：`docs/reports/stage3/stage3_narrative.md`
...
1. `docs/reports/stage3/stage3_results_summary.md`
2. `docs/reports/stage3/stage3_narrative.md`
3. `docs/reports/stage3/stage3_report_{hotpotqa,musique,2wiki}.md`
4. `docs/reports/stage3/stage3_report_*_{sudden,gradual,periodic}.md`
