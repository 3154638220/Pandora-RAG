...
| 0.1 | Probe+CP | 0.5383 | 0.4370 | 4.32 | 0.782 |
  ...
  Selective Prediction (abstain if pre-sample wealth ≥ cap): coverage=0.732, selective_acc=0.634, abstained=268, first_abstain_idx=74
...
| 0.2 | Probe+CP | 0.5536 | 0.4210 | 3.75 | 0.693 |
  ...
  Selective Prediction (abstain if pre-sample wealth ≥ cap): coverage=0.883, selective_acc=0.623, abstained=117, first_abstain_idx=164
