...
| 0.1 | Probe+CP | 0.6716 | 0.2960 | 4.11 | 0.752 |
  ...
  E-wealth final=0.0343, cap=1/α=10.0
  Selective Prediction (abstain if pre-sample wealth ≥ cap): coverage=0.936, selective_acc=0.710, abstained=64, first_abstain_idx=40
