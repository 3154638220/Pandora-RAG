...
| 0.1 | Probe+CP | 0.5383 | 0.4370 | 4.32 | 0.782 |
  ...
  Selective Prediction (abstain if pre-sample wealth ≥ cap): coverage=0.796, selective_acc=0.753, abstained=204, first_abstain_idx=797
...
| 0.2 | Probe+CP | 0.5536 | 0.4210 | 3.75 | 0.693 |
  ...
  Selective Prediction (abstain if pre-sample wealth ≥ cap): coverage=0.911, selective_acc=0.668, abstained=89, first_abstain_idx=912
