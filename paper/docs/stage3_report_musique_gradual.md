...
| 0.1 | Probe+CP | 0.4015 | 0.5971 | 4.85 | 0.770 |
  ...
  Selective Prediction (abstain if pre-sample wealth ≥ cap): coverage=0.547, selective_acc=0.763, abstained=189, first_abstain_idx=229
...
| 0.2 | Probe+CP | 0.4047 | 0.5923 | 4.67 | 0.701 |
  ...
  Selective Prediction (abstain if pre-sample wealth ≥ cap): coverage=0.614, selective_acc=0.680, abstained=161, first_abstain_idx=257
