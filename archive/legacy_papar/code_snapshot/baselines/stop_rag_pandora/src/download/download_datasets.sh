...
uv run --no-sync python -m download.subsample_data --dataset hotpotqa --num-eval 1000 --num-test 1000
...
uv run --no-sync python -m download.subsample_data --dataset 2wikimultihopqa --num-eval 1000 --num-test 1000
...
uv run --no-sync python -m download.subsample_data --dataset musique --num-eval 1000 --num-test 1000
